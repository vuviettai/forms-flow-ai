window["_env_"] = {
    NODE_ENV: "production",
    REACT_APP_API_SERVER_URL:"http://192.168.1.3:3001",
    REACT_APP_API_PROJECT_URL:"http://192.168.1.3:3001",
    REACT_APP_KEYCLOAK_CLIENT:"forms-flow-web",
    REACT_APP_KEYCLOAK_URL_REALM:"{realm-name}",
    REACT_APP_KEYCLOAK_URL:"http://192.168.1.3:8080",
    REACT_APP_WEB_BASE_URL:"http://192.168.1.3:5000",
    REACT_APP_BPM_URL:"http://192.168.1.3:8000/camunda",
